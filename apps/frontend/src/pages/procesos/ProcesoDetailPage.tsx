...
import {
  ArrowLeft, Edit2, Loader2, Layers, BookOpen,
  Zap, Calendar, User, Tag,
} from 'lucide-react';
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {canCreateProceso && (
          <button
            ...
            className="flex items-center gap-2 text-xs border border-[#2A2A2A] text-[#666] hover:text-white hover:border-[#444] px-3 py-2 rounded-lg transition-colors flex-shrink-0"
          >
